...
def kshingle(ai_abstracts_train, ai_abstracts_test, non_ai_abstracts):
    ...
    for k in k_values:
        ...
        # threshold_percentages = [0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8]
        ...
        for threshold_percentage in threshold_percentages:
            ...
            plot_scatter(y_values, ai_threshold, k, accuracy, f'kshingle/{k}_shingle_tokens_{threshold_percentage}_threshold.png')

            y_values_line_graph.append(accuracy * 100)

        y_values_matrix.append(y_values_line_graph)
    plot_line_graph(x_values_line_graph, y_values_matrix, k_values, 'kshingle/accuracy_vs_threshold_percentage_1.png')
